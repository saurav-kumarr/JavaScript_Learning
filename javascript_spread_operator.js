// Spread Operator (...) : Used to expand elements of an iterable (like arrays or strings)
// or properties of object into individual elements or properties.
...
console.log(Math.max(...originalArray));
